...
model = dict(
    ...
    stage2_head=dict(
        ...
        decoder=dict(
            ...
            transformerlayers=dict(
                type='ConditionalPIDetrTransformerDecoderLayer',
                attn_cfgs=[
                    dict(
    ...
    test_cfg=dict(
        # ensemble_stages=[num_layers, num_layers+1],
        ensemble_stages=[num_layers, num_layers+1],
        iou_thr=.25,
        score_thr=.01,
    ),
...
load_from = 'deform_detr-epoch_10.pth'
# resume_from = 'work_dirs/mix_bbox_mask_cascade_lose_top5_7_selective_512_layer2_2gpu/epoch_11.pth'